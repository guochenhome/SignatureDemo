...
public class SignatureView extends View {
    ...
    private SubImageListenr listenr;

    public SubImageListenr getListenr() {
        return listenr;
    }

    public void setListenr(SubImageListenr listenr) {
    ...
    public interface SubImageListenr{
       void doSubmit(Bitmap bitmap);
    }
